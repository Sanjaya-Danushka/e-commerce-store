...
const SalePage = ({ cart, wishlist, refreshCart }) => {
  ...
  useEffect(() => {
    const fetchSaleProducts = async () => {
      try {
        ...
        setAllSaleProducts(products.slice(0, 8));
  ...
  useEffect(() => {
    ...
    if (searchQuery.trim() === "") {
      ...
      const filtered = allSaleProducts.filter((product) =>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 lg:py-28">
          <div className="text-center">
            ...
            <p className="text-xl md:text-2xl mb-12 opacity-90 max-w-3xl mx-auto leading-relaxed animate-slide-up animation-delay-200">
              Don't miss our biggest sale of the year! Limited time offers on thousands of premium products from top brands worldwide.
            </p>
            ...
            {[
              {
                ...
                icon: '📱',
                bgImage: '/images/banners/sales-banners/electronics-flash-sale.jpg'
              },
              {
                name: 'Fashion Sale',
                discount: '70% OFF',
          ...
          {saleProducts.length === 0 ? (
            <div className="text-center py-20">
              ...
              <p className="text-gray-600 text-lg mb-8 max-w-md mx-auto">
                We couldn't find any products matching your search. Try adjusting your search terms or browse all our sale items.
              </p>
              <button
                onClick={() => handleSearch("")}
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-4 gap-6 justify-items-center">
              {saleProducts.map((product) => (
                <div key={product.id} className="group bg-white rounded-3xl shadow-xl hover:shadow-2xl transition-all duration-500 p-8 transform hover:-translate-y-3 border border-gray-100 hover:border-red-200 w-full max-w-lg">
                  ...
                  <div className="space-y-6">
                    <div className="product-name h-24">
                      <h3 className="font-bold text-gray-900 text-xl leading-tight line-clamp-2 group-hover:text-red-600 transition-colors duration-200">
                        {product.name}
                      </h3>
                    </div>

                    <div className="flex items-center space-x-3">
                      <div className="product-price text-3xl font-bold bg-gradient-to-r from-red-600 to-pink-600 bg-clip-text text-transparent">
                    ...
                    <button
                      className="add-to-cart-button w-full bg-gradient-to-r from-red-600 to-pink-600 hover:from-red-700 hover:to-pink-700 text-white font-bold py-4 px-6 rounded-xl transition-all duration-300 flex items-center justify-center text-lg shadow-lg hover:shadow-xl transform hover:scale-105"
                      onClick={() => {
                        axios
                          .post("/api/cart-items", {
