      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <nav className="hidden md:flex items-center space-x-8">
            ...
            <Link to="/sale" className="text-red-600 hover:text-red-700 text-sm font-medium">
              Sale
            </Link>

            <Link to="/new-arrivals" className="text-gray-700 hover:text-gray-900 text-sm font-medium">
              New
            </Link>
          </nav>
